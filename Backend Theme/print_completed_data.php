...
<body data-topbar="dark">
        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0">Completed Registration Form</h4>
                    ...
                    <div class="row">
                        <!-- <h6 align="right"><button class="btn btn-danger print">Print form</button></h6> -->
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4" align="center">
                                        <img class="img img-fluid" src="./assets/images/logo.png" style="width:6rem">
                                        <h4 align="center">Vehicle Registration completed form</h4>
                                    </h4>
    ...
    $.ajax({
        url: './server/print_registration_form.php',
        method: 'post',
        data: {
            action: action,
            id: registration_id,
