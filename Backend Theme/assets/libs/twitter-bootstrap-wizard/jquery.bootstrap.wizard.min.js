...
(function(e){
    var n = function(d, k){
      ...
      this.fixNavigationButtons = function(){
        ...
        if (c.onTabShow && typeof c.onTabShow === "function" && c.onTabShow(f, b, a.currentIndex()) === false) {
          return false;
        }
      };
      ...
      this.next = function(h){
            h = a.currentIndex();
            $index = a.nextIndex();
            if($(`.form_section_${$index}`).parsley().validate()){
                if ($index <= a.navigationLength()) {
                    g.push(h);
                    b.find('li:has([data-toggle="tab"]):eq(' + $index + ') a').tab("show");
                  }  
                  if (d.hasClass("last") || (c.onNext && typeof c.onNext === "function" && c.onNext(f, b, a.nextIndex()) === false)) {
                      return false;
                    }
            }
            else{
      ...
      this.previous = function(h){
        if (d.hasClass("first") || (c.onPrevious && typeof c.onPrevious === "function" && c.onPrevious(f, b, a.previousIndex()) === false)) {
          return false;
        }
      ...
      this.first = function(h){
        if ((c.onFirst && typeof c.onFirst === "function" && c.onFirst(f, b, a.firstIndex()) === false) || d.hasClass("disabled")) {
          return false;
        }
      ...
      this.last = function(h){
        if ((c.onLast && typeof c.onLast === "function" && c.onLast(f, b, a.lastIndex()) === false) || d.hasClass("disabled")) {
          return false;
        }
      ...
      this.back = function(){
        ...
        var a = g.pop();
        if (c.onBack && typeof c.onBack === "function" && c.onBack(f, b, a) === false) {
          g.push(a);
          return false;
        }
      ...
      this.remove = function(a){
        var c = typeof a[1] !== "undefined" ? a[1] : false;
      ...
      var l = function(d){
            ...
            g = e(g[d]);
            if (c.onTabClick && typeof c.onTabClick === "function" && c.onTabClick(f, b, a.currentIndex(), d, g) === false) {
              return false;
            }
        // }
      ...
      var m = function(d){
        ...
        if ($element.hasClass("disabled") || (c.onTabChange && typeof c.onTabChange === "function" && c.onTabChange(f, b, a.currentIndex(), d) === false)) {
          return false;
        }
        f = $element;
      ...
      b = d.find("ul:first", d);
      f = b.find('li:has([data-toggle="tab"]).active', d);
      if (!b.hasClass(c.tabClass)) {
        b.addClass(c.tabClass);
      }
